...
import { Skeleton, Text, Button, Box, VStack, Center, NativeBaseProvider, Avatar, Heading, HStack } from "native-base";
      ...
      <Box w="90%" maxWidth="400">
        <VStack maxWidth="400" borderWidth="1" space={8} overflow="hidden" rounded="md" _dark={{
          ...
          <Skeleton h="40" isLoaded={isLoaded}>
            <Center><RNImage style={{ width: 200, height: 200 }} source={(require("../img/logo-carita.png")
            )} /></Center>
          </Skeleton>
